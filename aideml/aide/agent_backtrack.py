...
# EDA_MEMORY must stay empty by default. Any injection is applied exclusively at
# runtime by Adversarial_EDA/AIDE/eda_hook.py (driven by the EDA_FINDINGS env var),
# so the Thompson/backtracking control run (EDA_FINDINGS unset) is truly clean.
EDA_MEMORY = ""
...
class Agent:
    ...
    def _draft(self) -> Node:
        ...
        prompt: Any = {
            ...
            "Memory": EDA_MEMORY + self.journal.generate_summary(),
            "Instructions": {},
        }
