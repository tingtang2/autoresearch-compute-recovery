...
def query(
    ...
    **model_kwargs,
    ...
    # Reasoning models (o-series, gpt-5-mini) don't support temperature
    _model = filtered_kwargs.get("model", "")
    _NO_TEMP_PREFIXES = ("o1", "o3", "o4-mini", "gpt-5-mini")
    if any(_model.startswith(p) for p in _NO_TEMP_PREFIXES):
